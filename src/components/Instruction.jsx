        ...
        <div className="py-4">
          <div className="row align-items-center justify-content-around">
            ...
            <div className={`col-12 col-md-6 order-md-2 ${styles.card}`}>
              ...
              <p>
                Now it's time to customize your card. You can change the colour,
                font and size of the text, or add another text field. You can
                even add images to give it a professional edge. You're in
                control.
              </p>
            </div>
          </div>
        ...
        <div className="py-4">
          <div className="row align-items-center justify-content-around">
            ...
            <div className={`col-12 col-md-6 order-md-1 ${styles.card}`}>
              ...
              <p>
                After adding those final touches, you can easily save your card
                to your device. Or take advantage of our sharing feature and
                instantly share it with your friends, family, and colleagues!
              </p>
            </div>
          </div>
        </div>
